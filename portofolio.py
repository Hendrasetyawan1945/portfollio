...
with col2 :
    ...
    st.write("[Instagram](https://www.instagram.com/bi.ruu_/) | [GitHub](https://github.com/Hendrasetyawan1945) | [LinkedIn](https://www.linkedin.com/in/hendra-cahyo-setiawan-b29a781a5/)")
...
with col1:
    ...
    st.markdown("📅 Belajar Machine Learning untuk Pemula "'<a href="" target="_blank" download><img src="https://img.icons8.com/color/452/pdf.png" width="16"> Download Sertifikat</a>', unsafe_allow_html=True)
